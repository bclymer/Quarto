(function ($) {
	...
	Quarto.waitingRoom = (function () {
		...
		function start() {
			...
			$.get("/rooms", function (data) {
				...
				$('#rooms-table').on('click', '.join-room', function (event) {
					...
					Quarto.socket().sendMessage(Quarto.constants.joinRoom, room);
			...
			$('#submit-new-room').on('click', function (event) {
				...
				Quarto.socket().sendMessage(Quarto.constants.addRoom, room);
				Quarto.main().loadGameHTML();
			});
			...
			$(document).on(Quarto.constants.joinRoom, function(event, userRoom) {
		...
		function stop() {
			...
			$('#waiting-room').hide();
			$(document).off(Quarto.constants.addRoom)
						.off(Quarto.constants.changeRoom)
						.off(Quarto.constants.removeRoom)
						.off(Quarto.constants.joinRoom)
						.off(Quarto.constants.addUser)
						.off(Quarto.constants.removeUser);
			loaded = false;
